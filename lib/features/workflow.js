...
/**
 * Runs review for the currently active chunk.
 * @param {Object} app
 * @param {Object} [options]
 * @param {string} [options.customPrompt]
 * @param {string} [options.thinkingEffort]
 * @returns {Promise<{ ok: boolean, error?: string }>}
 */
export async function handleRunReview(app, { customPrompt = "", thinkingEffort = null } = {}) {
